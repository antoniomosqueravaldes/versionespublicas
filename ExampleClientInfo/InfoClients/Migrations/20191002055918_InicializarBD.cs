        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Employecode = table.Column<string>(maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateId = table.Column<int>(nullable: false),
                    CityId = table.Column<int>(nullable: false),
                    CreditLimit = table.Column<int>(maxLength: 4, nullable: false),
                    AvailableCredit = table.Column<int>(maxLength: 4, nullable: false),
                    VisitsPercentage = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Visits_SalesRepresentatives_SalesRepresentativeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_SalesRepresentativeId",
                table: "Visits",
