...
namespace InfoClients.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(DbInfoClientesContext context)
        {
            _context = context;
        }
        ...
        {
            var dbInfoClientesContext = _context.Cities.Include(c => c.States);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,Name,Code,StateId")] City city)
        {
            if (id != city.CityId)
            {
                return NotFound();
